        ...
        case "getMotelDetail":
            ...
            if (($CheckOutDate - $CheckInDate) < 1) {
                ...
                if(!isValidMotel($AccomIdx)) {
                    ...
                    if ($jwt == null) { // 비회원
                        $res->Result->PhotoCount = getMotelPhoto($AccomIdx);
                        $res->Result->ReviewCount = getMotelReview($AccomIdx);
                        $res->Result->ReviewReplyCount = getMotelReviewReply($AccomIdx);
                        $res->Result->MotelDetail = getMotelDetail($AccomIdx);
                        ...
                        if (!isValidHeader($jwt, JWT_SECRET_KEY)) {
                            ...
                            $res->Result = getMotelDetailMember($AccomIdx);
                            $res->IsSuccess = TRUE;
                            $res->Code = 201;
